...
2.$\displaystyle f(x)\geq0,[f(x+1)]^2+[f(x)]^2=73(x\in\mathbb{R}).\text{当}x\in[0,1)\text{时}$,$f(x)=10-|13x-4|$,$\displaystyle f(\frac{2021}{13})=$\\
解：$[f(x+1)]^2+[f(x)]^2=73\Rightarrow[f(x+2)]^2+[f(x+1)]^2=73\Rightarrow[f(x+2)]^2=[f(x)]^2$\\
$\because f(x)\geq0\therefore f(x+2)=f(x)$\\
$\displaystyle f(\frac{2021}{13})=f(\frac{19}{13})$,由$\displaystyle\because [f(\frac{19}{13})]^2+[f(\frac{6}{13})]^2=73$\\
